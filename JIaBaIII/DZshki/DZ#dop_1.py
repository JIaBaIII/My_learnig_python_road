...
#     my_new_list_reverse = list(my_new_list[::-1])
#     for i in my_new_list:
#         if i == ' ':
#             my_new_list.remove(' ')
#             my_new_list_reverse.remove(' ')
#     if my_new_list == my_new_list_reverse:
#         print('Еба, это ж палиндром!')
#     else:
#         print('Это не палиндром')
#
#
# look_for_palidrom('лёша на полке клопа нашёл')        # Первый вариант решения
...
#       # Второй вариантик ((оказыввется стабильней первого))
